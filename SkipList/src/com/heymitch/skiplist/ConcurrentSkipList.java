...
public class ConcurrentSkipList<T> {
	...
	private static int max_level_inserted = 0; // highest level we've placed a number
	private int num_skips_fwd = 0;
	private int num_drop_downs = 0;
	private int num_locked_nodes = 0;
	...
	public int GetNumLevels() {
		return max_level_inserted;
	}

	public int GetNumDropDowns() {
		return num_drop_downs;
	}

	public int GetNumSkipsFwd() {
		return num_skips_fwd;
	}

	public int GetNumLocks() {
		return num_locked_nodes;
	}
